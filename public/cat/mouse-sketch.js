 ...
 */
 ...
 function draw() {
     ...
     let data = { fish_positions: [
         ...
         touch_positions:{posX: touchPosX/windowWidth, posY: touchPosY/windowHeight}, drawType: {type: 'mouse', bg_r: red(bgColor), bg_g: green(bgColor), bg_b: blue(bgColor)}, temp_positions: {posX: tempFishPosX/windowWidth, posY: tempFishPosY/windowHeight, angle: tempFishAngle}, title: {nickname: titleNickname}};
